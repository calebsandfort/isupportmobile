...
class CustomerSalesNotesPropertyNames extends PropertyNamesBase {
  ...
  get customerGuid (): string {
    return super.resolvePropertyName("CustomerGuid");
  }
  get opportunityGuid (): string {
    return super.resolvePropertyName("OpportunityGuid");
  }
...
export default CustomerSalesNotesPropertyNames;
